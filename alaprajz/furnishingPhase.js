...
function placeSomething() {
    ...
    furnitures.push({name: name_prompt ,data: furniture, products: [], separators: [], info: {direction: '', start: {x: 0, y: 0}, end: {x: 0, y: 0}}, distance_from_walls: nearest_walls, scaled: false});
}
