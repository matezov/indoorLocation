function setProduct(index, e) {
    ...
    const obj = [{ firstPoint: furnitures[index].separators[furnitures[index].separators.length - 1].firstPoint,
                    secondPoint: furnitures[index].separators[furnitures[index].separators.length - 1].secondPoint },
