    ...
    for (let i = 0; i < plan.furnitures.length; ++i) {
        ...
        if (lor === 'left') {
            switch (plan.furnitures[i].data[vind].direction) {
                case 'North':
                    //plan.furnitures[i].data[vind].firstPoint.x = plan.furnitures[i].distance_from_walls.vertical.secondPoint.x + scale * plan.furnitures[i].distance_from_walls.vertical.dist;
